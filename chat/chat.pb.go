...
type Message struct {
	...
	Body string `protobuf:"bytes,1,opt,name=body,proto3" json:"body,omitempty"` //buradaki 1 sıra numarasıdır. Değer ataması değildir.
}
...
var file_chat_proto_rawDesc = []byte{
	...
	0x2e, 0x3b, 0x63, 0x68, 0x61, 0x74, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
